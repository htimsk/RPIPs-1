...
- Establishes that the minimum RPL stake to launch a minipool or receive RPL rewards is 10% of matched protocol ETH on a per-node basis.
...
We are opting for 8LEBs, instead of e.g., 4-ETH LEBS, for a few reasons. First, there is much more safety
